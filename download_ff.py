...
MODIFIED: Changed 'output_path' to an optional argument that defaults to
          'data/ff_raw_videos' within the project structure.
Example usage:
...
# Make the script aware of our project directory
PROJECT_ROOT = Path(__file__).parent
DEFAULT_OUTPUT_PATH = PROJECT_ROOT / "data" / "ff_raw_videos"
# --- End of Modification ---
...
def parse_args():
    ...
    # --- Start of Modification ---
    # Changed output_path from a required positional argument to an optional one
